        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Moderations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Moderations_Status_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FanFictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FanFictions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FanFictions_Fandoms_FandomId",
                        column: x => x.FandomId,
                        principalTable: "Fandoms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FanFictions_Moderations_ModerationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chapters_FanFictions_FanFictionId",
                        column: x => x.FanFictionId,
                        principalTable: "FanFictions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_FanFictions_FanFictionId",
                        column: x => x.FanFictionId,
                        principalTable: "FanFictions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserRatings_FanFictions_FanFictionId",
                        column: x => x.FanFictionId,
                        principalTable: "FanFictions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_FanFictionId",
                table: "Chapters",
                column: "FanFictionId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_FanFictionId",
                table: "Comments",
                column: "FanFictionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FanFictions_FandomId",
                table: "FanFictions",
                column: "FandomId");

            migrationBuilder.CreateIndex(
                name: "IX_FanFictions_ModerationId",
                table: "FanFictions",
                column: "ModerationId");

            migrationBuilder.CreateIndex(
                name: "IX_FanFictions_UserId",
                table: "FanFictions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Moderations_StatusId",
                table: "Moderations",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Moderations_UserId",
                table: "Moderations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRatings_FanFictionId",
                table: "UserRatings",
                column: "FanFictionId");
